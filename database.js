...
db.fish.insert(
  [
    ...
    {species: "Perch", fishLength: 2, weight: .32, girth: 1, location: "Baby Lake", gear: "Jig Minnow", weather: "Cold and Cloudy", email: 'j.schoolmee@gmail.com'},
    {species: "Muskie", fishLength: 70, weight: 17, girth: 12, location: "Baby Lake", gear: "Silver Spoon", weather: "Sunny and Clear", email: 'jonathan.p.mattox@gmail.com'}
  ]
);
